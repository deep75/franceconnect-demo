			...
			<div>
				<p class="well">
					<security:authorize access="hasRole('ROLE_USER')">
						<b><span class="text-success">Vous etes connect� !</span></b>
					</security:authorize>
					<security:authorize access="!hasRole('ROLE_USER')">
						<b><span class="text-error">Vous n'�tes <em>PAS</em> connect�.</span></b>			
					</security:authorize>
				</p>
				
				<p>Cette application de demo est configur� avec plusieurs pages n�cessitant diff�rents r�les. 
				Cette page ne n�cessite pas d'�tre connect�.
				</p>
			
				<ul>
					<li><a href="user">User</a>, n�cessite d'�tre connect� avec le r�le  <code>ROLE_USER</code> (Spring Security authority). Ce r�le est donn�es � toute personne connect�</li>
					<li><a href="admin">Admin</a>, n�cessite d'�tre connect� avec le r�le <code>ROLE_ADMIN</code> (Spring Security authority). Ce r�le est donn�es uniquement aux personne ayant le nom 'admin'</li>
					<security:authorize access="hasRole('ROLE_USER')">
						<li><a href="${pageContext.request.contextPath}/j_spring_security_logout">D�connexion</a></li>
					</security:authorize>
					<security:authorize access="!hasRole('ROLE_USER')">
